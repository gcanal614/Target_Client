...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (Alt alt : alts) {
            ...
            FontManager.yaHei18.drawString("账号: " + ChatFormatting.GRAY + alt.getAccount(),60,altY + 2,-1);
            FontManager.yaHei18.drawString("密码: " + (alt.getPassword().equals("NULL_PASSWORD") ? ChatFormatting.RED + "离线账户" : ChatFormatting.GRAY + alt.getPassword().replaceAll(".","*")),60,altY + 12,-1);
            FontManager.yaHei18.drawString("游戏名: " + ChatFormatting.GRAY + alt.getUserName(),60,altY + 22,-1);
