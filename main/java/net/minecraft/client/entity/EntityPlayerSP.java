...
import love.target.events.EventChatPlayer;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public boolean isMoving() {
        return this.movementInput.moveStrafe != 0.0f || this.movementInput.moveForward != 0.0f;
    }

    public boolean isForwardMove() {
        return movementInput.moveForward == 1.0f;
    }
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        EventPreUpdate eventPreUpdate = new EventPreUpdate(onGround,rotationYaw,rotationPitch,getEntityBoundingBox().minY);
        ...
        this.getEntityBoundingBox().minY = oldY;
    ...
    {
        EventChatPlayer eventChatPlayer = new EventChatPlayer(message);
        EventManager.call(eventChatPlayer);
        if (eventChatPlayer.isCancelled() || CommandManager.onChat(message)) return;
